...
class sweatandtearstraining_comSpider(Spider):
    name = "sweatandtearstraining_com"
    count = 0
    custom_output = False
    use_selenium = True
    start_url = [
            'https://sweatandtearstraining.com/category/best-of/',
        'https://sweatandtearstraining.com/category/cardiovascular/',
        'https://sweatandtearstraining.com/category/diet/',
        'https://sweatandtearstraining.com/category/health/',
        'https://sweatandtearstraining.com/category/motivation/',
        'https://sweatandtearstraining.com/category/reviews/',
        'https://sweatandtearstraining.com/category/weight-training/'
    ]
    ...
    def parse1(self, response):
        urls = response.xpath('//main[@id="main"]/article/div/header/h2/a/@href').extract()
        if not urls:
            return
    ...
    def parse(self, response):
        ...
        date = response.xpath('//time[@class="entry-date published"]/@datetime').extract_first().split('+')[0]
        if date:
        ...
        img_urls = response.xpath('//div[@class="inside-article"]/div/img') + response.xpath('//div[@class="entry-content"]//img')
