...
class missirosesviews_comSpider(Spider):
    name = "missirosesviews_com"
    count = 0
    custom_output = False
    use_selenium = True
    start_url = [
            'https://www.missirosesviews.com/category/giveaway/',
            'https://www.missirosesviews.com/category/recipes/cocktails/',
            'https://www.missirosesviews.com/category/disney/',
            'https://www.missirosesviews.com/category/lifestyle/',
            'https://www.missirosesviews.com/category/beauty/',
            'https://www.missirosesviews.com/category/healthy/',
            'https://www.missirosesviews.com/category/entertainment/',
            'https://www.missirosesviews.com/category/travel/',
            'https://www.missirosesviews.com/category/pets/',
            'https://www.missirosesviews.com/category/automobiles/',
            'https://www.missirosesviews.com/category/gift-ideas/'
    ]
