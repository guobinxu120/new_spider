...
class tamaracamerablog_comSpider(Spider):
    name = "tamaracamerablog_com"
    count = 0
    custom_output = False
    use_selenium = True
    start_url = [
            'https://tamaracamerablog.com/'
    ]
    ...
    def parse2(self, response):
        ...
        item = OrderedDict()
        keys_texts = response.xpath('//span[@class="breadcrumb-link-text-wrap"]/text()').extract()
        ...
        img_urls = response.xpath('//div[@class="entry-content"]/div[@class="bpp_post_wrapper"]//img')
        ...
        tags = response.xpath('//div[@class="entry-content"]/div[@class="bpp_post_wrapper"]/*')
        total_text = ''
        for i, tag in enumerate(tags):
            ...
            # else:
                ...
                text = delettags(text)
                if text == '<p></p>' or text == '<div></div>' or "google_ads_iframe" in text \
